            ...
            <div class="py-3 mb-2">
                <div class="mr-5">
                    <h6 class="mb-0">
                        ...
                        <router-link to="/orders"> Gerenciar Vendas </router-link> >
                        <router-link :to="`/view-order/${order.id}`"> {{ order.tracking_number }} </router-link>
                    </h6>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 order-details text-start">
                            ...
                            <h6 class="mb-2">
                                ...
                                <strong style="color: #666666;">
                                    {{ (order.message.length > 2) ? order.message : 'Sem observação' }}
                                </strong>
                            </h6>
                            <br>
                        </div>
